...
class SessionManager:
    def __init__(self, workspace_root: str):
        ...
        # Sessions stored in data/recordings
        self.sessions_dir = self.workspace_root / "data" / "recordings"
...
def ensure_session_dirs(workspace_root: str, session_id: str) -> None:
    ...
    # New structure: data/recordings + output/*
    dirs = [
        base / "data" / "recordings" / session_id,
        base / "output" / "proxies" / session_id,
        base / "output" / "audio" / session_id,
        base / "output" / "transcripts" / session_id,
        base / "output" / "analysis" / session_id,
        base / "output" / "cutmaps" / session_id,
        base / "output" / "exports" / session_id,
        base / "output" / "thumbnails" / session_id / "frame_grabs",
        base / "output" / "briefs" / session_id,
    ]
    for d in dirs:
