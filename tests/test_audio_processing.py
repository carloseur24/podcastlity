...
def run_filter_chain(input_path: str, filter_chain: str, output_path: str, 
...
class TestConfigSettings:
    ...
    def test_longform_loudnorm_settings(self):
        ...
        assert targets.get("LRA") == 14, (
            f"Longform LRA should be 14, got {targets.get('LRA')}. "
            "LRA=9 is impossible to achieve on voice with natural LRA=20 "
            "without loudnorm destroying integrated loudness."
        )
